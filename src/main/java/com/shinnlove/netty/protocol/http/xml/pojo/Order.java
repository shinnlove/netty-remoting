 ...
 * @version $Id: Order.java, v 0.1 2018-06-29 下午12:05 shinnlove.jinsheng Exp $$
 */
public class Order {
    ...
    public String toString() {
        return "Order [orderNumber=" + orderNumber + ", customer=" + customer + ", billTo="
               + billTo + ", shipping=" + shipping.toString() + ", shipTo=" + shipTo + ", total="
               + total + "]";
    }
